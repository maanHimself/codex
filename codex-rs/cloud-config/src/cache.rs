...
impl CloudConfigBundleCache {
    ...
    pub(super) async fn load(
    ...
    ) -> Result<CloudConfigBundleCacheSignedPayloadV1, CacheLoadStatus> {
        ...
        let cache_file: CloudConfigBundleCacheFileV1 = match serde_json::from_slice(&bytes) {
    ...
    pub(super) async fn save(
        ...
        let signed_payload = CloudConfigBundleCacheSignedPayloadV1 {
        ...
        let serialized = serde_json::to_vec_pretty(&CloudConfigBundleCacheFileV1 {
...
pub(super) struct CloudConfigBundleCacheFileV1 {
    pub(super) signed_payload: CloudConfigBundleCacheSignedPayloadV1,
    pub(super) signature: String,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub(super) struct CloudConfigBundleCacheSignedPayloadV1 {
...
pub(super) fn cache_payload_bytes(
    payload: &CloudConfigBundleCacheSignedPayloadV1,
) -> Option<Vec<u8>> {
